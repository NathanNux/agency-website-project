...
const ShopifyStores = () => {
    ...
    return (
        <section className="mt-10 md:py-10 bg-[#b6b2a5] w-full rounded-3xl">
            <div className="p-4 mx-auto relative z-10 w-full">
                <div className="text-4xl py-10 md:pb-8 md:text-7xl text-center bg-clip-text text-transparent bg-gradient-to-b from-neutral-900 to-neutral-400 bg-opacity-50">
                    Vývoj Obchodů <br />
                </div>
                <p className="mt-4 text-lg font-normal  text-neutral-800 max-w-lg text-center mx-auto">
                    Vytváříme úžasné obchody pro Váše podniky, které jsou určeny ke konverzi.
                </p>
                      ...
                      >
                        <div className="flex flex-col items-center justify-center ">
                          <Image
                            ...
                            width={400}
                            height={400}
                            className="rounded-lg mx-auto slider-image shadow-xl cursor-pointer"
                          />
