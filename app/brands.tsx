...
const Brands = () => {
    return (
        <div>
            ...
            >
                Ty největší značky <br /> si nás vybraly
            </div>
                <p className="mt-4 text-lg font-normal  text-neutral-300 max-w-lg text-center mx-auto">
                    Od malých podniků po velké korporace, <br /> všem jsme pomohli
                    pozvednou své podnikání na novou úroveň.
                </p>
                <div className='grid grid-cols-3 items-center justify-center mx-auto md:w-3/5 cursor-pointer'>
                    {logos.map((logo, i) => (
                        ...
                        <Image
                            ...
                            height={500}
                            alt="logo"
                            className="w-full h-auto max-w-full rounded-lg slider-image"
                        />
                        </div>
                    ))}
                </div>
                <div 
                    className={cn('flex items-center justify-center text-xl xl:text-2xl pt-10 md:pt-0 pb-4 px-8 text-center text-white',
                    font.className
                    )}
                >
                ...
                <div className='items-center flex justify-center flex-col text-white'>
                   <Image 
                        ...
                        width={1000}
                        height={1000}
                        className="pt-2 xl:pt-0  w-10 xl:w-14 slider-image cursor-pointer"
                   /> 
